...
public class AnyChatCameraHelper implements SurfaceHolder.Callback {
    ...
    private List<Camera.Size> mPrviewSizeList;
    ...
    public void startRecord(String filePath, final int recordTime, final OnRecordListener listener) {
    ...
    //查找出最接近的视频录制分辨率
    private int bestVideoSize(List<Camera.Size> videoSizeList, int _w) {
        //降序排列
