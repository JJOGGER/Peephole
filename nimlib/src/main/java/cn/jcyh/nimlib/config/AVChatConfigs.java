...
public class AVChatConfigs {
    ...
    private void updateAVChatOptionalConfig() {
        ...
        avChatParameters.setInteger(AVChatParameters.KEY_VIDEO_FRAME_RATE, AVChatVideoFrameRate.FRAME_RATE_20);
    }
