...
public class MainFragment_gongsi extends BaseFragment {
...
//    ImageView ivHome;
    ...
    private static MainFragment_gongsi sInstance;
    private ProgressDialog mProgressDialog;
    private DoorbellConfig mDoorbellConfig;
    private MyReceiver mReceiver;
    private Disposable mSubscribe;

    public static MainFragment_gongsi getInstance(Bundle bundle) {
        if (sInstance == null) {
            synchronized (MainFragment_gongsi.class) {
                if (sInstance == null) {
                    sInstance = new MainFragment_gongsi();
                    if (bundle != null)
