...
public class MainFragment_beifen extends BaseFragment {
...
//    ImageView ivHome;
    ...
    private static MainFragment_beifen sInstance;
    private ProgressDialog mProgressDialog;
    private DoorbellConfig mDoorbellConfig;
    private MyReceiver mReceiver;
    private Disposable mSubscribe;

    public static MainFragment_beifen getInstance(Bundle bundle) {
        if (sInstance == null) {
            synchronized (MainFragment_beifen.class) {
                if (sInstance == null) {
                    sInstance = new MainFragment_beifen();
                    if (bundle != null)
