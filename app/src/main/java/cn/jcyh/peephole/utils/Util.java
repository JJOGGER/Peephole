...
//        String sdkPath = getAppCacheDir(getApp()) + "/nim"; // 可以不设置，那么将采用默认路径
...
//            return null;
//        return new LoginInfo(doorbellConfig.getDoorbell().getDeviceUserId(), doorbellConfig.getDoorbell().getToken());
        return null;
    }
    ...
    static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + getApp().getPackageName();
        }
