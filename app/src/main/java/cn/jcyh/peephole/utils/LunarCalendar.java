...
public class LunarCalendar {
    ...
    private static Date sBaseDate = new GregorianCalendar(1900, 0, 31).getTime();
    private static GregorianCalendar sObjDate = new GregorianCalendar();
    private static int[] sLunarDate = new int[4];
    ...
    public static final int[] solarToLunar(int year, int month, int monthDay) {
        sObjDate.set(year, month - 1, monthDay);
        Date objDate = sObjDate.getTime();
        int offset = (int) ((objDate.getTime() - sBaseDate.getTime()) / 86400000L);
        ...
        sLunarDate[1] = iMonth;
        sLunarDate[2] = offset + 1;
        sLunarDate[3] = isLeap ? 1 : 0;

        return sLunarDate;
    }

    public static final int[] solarToLunar(int[] lunarDate, Date baseDate, Date objDate) {
