...
/**
 * Created by jogger on 2018/7/20.未读消息
 */
public class MsgCircleView extends View {
    ...
    public MsgCircleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MsgCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        textSize = height - ScreenUtil.dip2px(6);
